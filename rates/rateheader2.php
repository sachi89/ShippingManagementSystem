                    ...
                    <div class="navbar-nav">
                        ...
                        <li class="nav-item dropdown"> <!-- bootstrap dropdown nav for paintings -->
                            ...
                            <div class="dropdown-menu text-light bg-dark">
                              <a class="dropdown-item text-light bg-dark" href="class.php">Freight Class</a>
                              <a class="dropdown-item text-light bg-dark" href="freight.php">Freight Type</a>
        					  <a class="dropdown-item text-light bg-dark" href="zone.php">Zone</a>
        					  <a class="dropdown-item text-light bg-dark" href="port.php">Port</a>
                            </div>
                        </li>
