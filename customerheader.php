            ...
            <div class="collapse" id="navbarToggleExternalContent">
                <div class="bg-dark p-4">
                    <div class="navbar-nav">
                        ...
                        <a class="nav-item nav-link" href="customer/quoteformc.php">Freight Quote and Booking</a>
                        <a class="nav-item nav-link" href="customer/customerpending.php">Orders</a>
